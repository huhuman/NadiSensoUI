...
namespace Lean.Touch
{
	...
	public class LeanCanvasSelectionBox : MonoBehaviour
	{
		...
		[Tooltip("The selection handler")]
		public LeanSelect Select;

		[Tooltip("The selection box prefab")]
		public RectTransform Prefab;

		[Tooltip("The transform the prefabs will be spawned on (NOTE: This RectTransform must fill the whole screen, like the main parentGameObject)")]
		...
		private void WriteTransform(RectTransform rect, LeanFinger finger)
		{
			...
			if (camera != null)
			{
				...
				// Reset pivotGameObject in case you forgot
				...
				if (Select != null)
				{
					...
					// Find all selectables within rect
					...
					// SelectTargetForTransform them
					Select.Select(finger, selectables);
				}
			}
		}
	}
