...
namespace Lean.Touch
{
	...
	public class LeanFingerHeldAction : MonoBehaviour
	{
		...
		[Tooltip("The minimum amount of seconds the template finger must have been pressed to call the event")]
		public float MinimumAge = 1.0f;

		// Called when a calling finger has been held for more than the template amount
