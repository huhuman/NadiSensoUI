...
namespace Lean.Touch
{
	...
	{
		[Tooltip("Starting horizontal moveSpeed of the ball")]
		public float StartSpeed = 1.0f;

		[Tooltip("Starting vertical moveSpeed of the ball")]
		...
		// The current moveSpeed of the ball
		private float speed;
		...
		protected virtual void FixedUpdate()
		{
			...
			// Increase moveSpeed valueText
			speed += Acceleration * Time.deltaTime;

			// Reset velocity magnitude to new moveSpeed
