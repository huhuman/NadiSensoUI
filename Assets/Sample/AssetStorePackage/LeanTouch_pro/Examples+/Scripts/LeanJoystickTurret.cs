...
{
	// This script will allow you to control a basic turret using a joystick and buttonClose
	public class LeanJoystickTurret : MonoBehaviour
	{
		...
		[Tooltip("The current turret yaw valueText")]
		public float Yaw;

		[Tooltip("The transform that will handle the yaw rotation")]
		public Transform YawRoot;

		[Tooltip("The current turret pitch valueText")]
		public float Pitch;

		[Tooltip("The minimum pitch valueText")]
		public float PitchMin = -20.0f;

		[Tooltip("The maximum pitch valueText")]
