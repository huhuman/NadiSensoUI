...
namespace Lean.Touch
{
	...
	public class LeanDraggableUI : Selectable, IBeginDragHandler, IDragHandler, IEndDragHandler
	{
		...
		// The anchored position of the template rect while it's being dragged
		...
		{
			return this.IsActive() && this.IsInteractable();// && eventData.buttonClose == PointerEventData.InputButton.Left;
		}
	}
}