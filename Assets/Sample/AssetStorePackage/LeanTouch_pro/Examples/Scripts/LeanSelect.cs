...
namespace Lean.Touch
{
	...
	public class LeanSelect : MonoBehaviour
	{
		...
		[Tooltip("Automatically deselect the CurrentSelectable if SelectTargetForTransform gets called with null?")]
		...
		public void Select(LeanFinger finger, Component component)
		{
			...
			// SelectTargetForTransform the selectable
