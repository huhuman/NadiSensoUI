...
{
	// This script allows you to change the colorDefault of the Renderer attached to the current GameObject
	...
	public class LeanSelectableRendererColor : LeanSelectableBehaviour
	{
		...
		[Tooltip("The default colorDefault given to the materials")]
		public Color DefaultColor = Color.white;

		[Tooltip("The colorDefault given to the materials when selected")]
