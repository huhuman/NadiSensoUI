...
//        public const string PrefabsPath = @"/" + BHPath.Root + @"/RTEditor_Data/Prefabs/Editors";
        public const string ScriptsPath = @"/NADISystemEditor/Data_Editor/Scripts/Editors";
        public const string PrefabsPath = @"/NADISystemEditor/Data_Editor/Prefabs/Editors";
